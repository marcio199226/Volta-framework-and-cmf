...
class Vf_Response
{
	...
	*/
	public function sendHttpHeaders($headers = null, $replace = true)
	{
		...
		else if($headers === null && sizeof($this -> headers) > 0)
		{
		...
		{
			throw new InvalidArgumentException('Argument header musi byc  tablica');
		}
		return $this;
	}
	...
	*/
	public function setHttpStatus($status = null)
	{
		...
		{
			throw new InvalidArgumentException('Argument status musi byc typu int');
		}
		return $this;
	}
