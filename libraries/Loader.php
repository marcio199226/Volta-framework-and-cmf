...
class Vf_Loader
{
	...
	public static function autoload($class)
	{
		...
		if($suff == 'Model')
		{
			...
			else if(self::existsFile(DIR_COMPONENTS.$suffix[1].'/'.DIR_MODELS.$suffix[1].'.php'))
			{
				require_once(DIR_COMPONENTS.$suffix[1].'/'.DIR_MODELS.$suffix[1].'.php');
			}
			else if(self::existsFile(DIR_PLUGINS.$suffix[1].'/'.DIR_MODELS.$suffix[1].'.php'))
			{
				require_once(DIR_PLUGINS.$suffix[1].'/'.DIR_MODELS.$suffix[1].'.php');
			}
			else if(self::existsFile(DIR_WIDGETS_MODELS.$suffix[1].'.php'))
			{
		...
		else
		{
			...
			else if(self::existsFile(DIR_LIBRARY.$suffix[1].'.php'))
			{
